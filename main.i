...
# 12 "/Users/labeall1/Desktop/Fall2017/CS2261/devkitARM/arm-none-eabi/include/stdlib.h" 2 3
...
# 8 "/Users/labeall1/Desktop/Fall2017/CS2261/devkitARM/arm-none-eabi/include/machine/_types.h" 2 3
...
# 19 "/Users/labeall1/Desktop/Fall2017/CS2261/devkitARM/arm-none-eabi/include/stdlib.h" 2 3
# 1 "/Users/labeall1/Desktop/Fall2017/CS2261/devkitARM/arm-none-eabi/include/sys/cdefs.h" 1 3
# 45 "/Users/labeall1/Desktop/Fall2017/CS2261/devkitARM/arm-none-eabi/include/sys/cdefs.h" 3
# 1 "/Users/labeall1/Desktop/Fall2017/CS2261/devkitARM/lib/gcc/arm-none-eabi/5.3.0/include/stddef.h" 1 3 4
# 46 "/Users/labeall1/Desktop/Fall2017/CS2261/devkitARM/arm-none-eabi/include/sys/cdefs.h" 2 3
# 20 "/Users/labeall1/Desktop/Fall2017/CS2261/devkitARM/arm-none-eabi/include/stdlib.h" 2 3
...
# 36 "/Users/labeall1/Desktop/Fall2017/CS2261/devkitARM/arm-none-eabi/include/stdio.h" 3
# 1 "/Users/labeall1/Desktop/Fall2017/CS2261/devkitARM/lib/gcc/arm-none-eabi/5.3.0/include/stddef.h" 1 3 4
...
# 48 "/Users/labeall1/Desktop/Fall2017/CS2261/devkitARM/arm-none-eabi/include/stdio.h" 3
...
void update(PLAYER* p, SQUARE* s, CAUGHT_SQUARE* cs)
{
 ...
 if((~((*(volatile unsigned int *)0x04000130)) & 32) && (p->col - (p->width/2) - 5) > 0) {
  p->col-=5;
  if(stack > 0) {
   cs->col-=5;
  }
 ...
 if((~((*(volatile unsigned int *)0x04000130)) & 16) && (p->col + (p->width/2) + 5) < 220) {
  p->col+=5;
  if(stack > 0) {
   cs->col+=5;
  }
...
{
 drawRect(p->oldRow - (p->width)/2, p->oldCol - (p->width)/2 , p->height, p->width, 0);
 drawRect(p->row - (p->width)/2, p->col - (p->width)/2 , p->height, p->width, ((31) | (0)<<5 | (0)<<10));
}


void drawFallingSquares(SQUARE *s)
{
 drawRect(s->oldRow, s->oldCol, s->height, s->width, 0);
 s->row++;
 drawRect(s->row, s->col, s->height, s->width, ((0) | (0)<<5 | (31)<<10));
}

void deleteSquares(SQUARE* s)
{
 drawRect(s->row, s->col, s->height, s->width, 0);
}
...
void drawCaughtSquares(CAUGHT_SQUARE* cs, SQUARE* s, PLAYER* p)
{
 ...
 drawRect(cs->oldRow, cs->oldCol, (s->height)*(stack-1), s->width, 0);
 drawRect(cs->row, cs->col, (s->height)*(stack-1), s->width, ((0) | (31)<<5 | (0)<<10));
}
...
void goToStart() {
 ...
 drawString(10, 20, buffer, ((0) | (0)<<5 | (31)<<10));
...
void goToPause() {
 ...
 drawString(80, 100, buffer, ((31) | (0)<<5 | (0)<<10));
 state = PAUSESCREEN;
}
...
void goToWin() {
 ...
 drawString(10, 20, buffer, ((0) | (31)<<5 | (0)<<10));

 sprintf(buffer, "PRESS START TO CONTINUE");
 drawString(20, 20, buffer, ((0) | (31)<<5 | (0)<<10));

 sprintf(buffer, "PRESS B TO RESTART");
 drawString(30, 20, buffer, ((0) | (31)<<5 | (0)<<10));
 state = WINSCREEN;
}
